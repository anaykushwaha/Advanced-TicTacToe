...
# It coordinates the players, board, game state, AI, and later the graphical interface too 
...
class Game: 
    ...
    def make_move(self, row: int, col: int) -> bool: 
        # Attempts to place the current player's symbol on the board 
    ...
    def update_game_state(self) -> None: 
        # Updates the current game state after a move 

        winning_symbol = self.board.check_winner()

        if winning_symbol is not None:

            if winning_symbol == self.player_one.symbol:
    ...
    def reset_board(self) -> None: 
        # Resets the board for a new round while keeping player scores unchanged 
    ...
    def reset_game(self) -> None: 
        # Resets the entire game session, including both player scores 
    ...
    def is_against_ai(self) -> bool: 
        # Checks whether Player Two is controlled by AI 
    ...
    def __repr__(self) -> str: 
        # Returns an unambiguous representation of the Game object 
