...
class AIPlayer: 
    ...
    def __init__(self, difficulty: str = AI_MEDIUM): 
        # Initializes the AI 
    ...
    def _impossible_move(
        ...
        # Selects the best possible move using the Minimax algorithm 
    ...
    def __str__(self) -> str: 
        # Returns a readable description of the AI 
    ...
    def __repr__(self) -> str: 
        # Returns an unambigious representation of the AIPlayer object 
